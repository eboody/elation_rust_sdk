...
mod tests {
    ...
    #[serial]
    #[tokio::test]
    async fn test_get_insurance_card_success() {
        ...
        let result = insurance_card_service.get(insurance_card_rank).await;
    ...
    async fn test_create_insurance_card_success() {
        ...
        let result = service.create(&insurance_card_for_create).await;
    ...
    async fn test_update_patch_insurance_card_success() {
        ...
        let result = insurance_card_service
            .update(insurance_card_rank, &insurance_card_fu)
            .await;
