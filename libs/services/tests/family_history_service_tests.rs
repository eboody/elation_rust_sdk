...
mod tests {
    ...
    use models::patient_profile::{
        FamilyHistory, FamilyHistoryForCreate, FamilyHistoryForUpdate, FamilyRelationship,
    };
    use patient_profile::FamilyHistoryService;
    ...
    async fn test_create_family_history_success() {
        ...
        let result = service.create(&family_history_for_create).await;
    ...
    async fn test_update_patch_family_history_success() {
        ...
        let result = family_history_service
            .update(family_history_id, &family_history_fu)
            .await;
